...
label monika_luojizhishisuzhuleimiuwudaocaorenmiuwu:
    ...
    m 4kub "\"你\"就开始慢慢动摇."
    extend 4hua "当然,价格看起来确认是便宜了,但是它的性能体验、{w=0.4}做工就很难得到保证."
...
label duhai_question_4:
    ...
    menu:
        ...
        "芥川龙之介":
            ...
            m 1euc "答错了哦."
            m 1hua "正确答案应该是屈原."
            m 3eud "芥川龙之介是日本新思潮派代表,他的短篇小说也很出名."
        "楚怀王":
...
label duhai_question_6:
    ...
    menu:
        ...
        "陈塘关":
            ...
            m 3ruc "......"
            extend 3fud "这应该是中国古代神魔小说《封神演义》中的一处关口地名."
            m 6tua "答错了哦,[player]."
            m 1hua "正确答案应该是嘉峪关."
        "嘉峪关":
